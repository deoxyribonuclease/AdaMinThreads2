...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_adaminthreads" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b85f6c8b#;
   pragma Export (C, u00001, "adaminthreadsB");
   ...
   u00172 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00172, "system__concat_4S");
   u00173 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00173, "system__concat_6B");
   u00174 : constant Version_32 := 16#fd3d7ca6#;
   pragma Export (C, u00174, "system__concat_6S");
   u00175 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00175, "system__concat_5B");
   u00176 : constant Version_32 := 16#a8a4123a#;
   pragma Export (C, u00176, "system__concat_5S");
   u00177 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00177, "system__random_numbersB");
   u00178 : constant Version_32 := 16#19a1600c#;
   pragma Export (C, u00178, "system__random_numbersS");
   u00179 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00179, "system__random_seedB");
   u00180 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00180, "system__random_seedS");
   u00181 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00181, "ada__calendarB");
   u00182 : constant Version_32 := 16#31350a81#;
   ...
   u00185 : constant Version_32 := 16#2e7731ce#;
   pragma Export (C, u00185, "system__soft_links__taskingB");
   u00186 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00186, "system__soft_links__taskingS");
   u00187 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00187, "ada__exceptions__is_null_occurrenceB");
   u00188 : constant Version_32 := 16#5ca174ae#;
   pragma Export (C, u00188, "ada__exceptions__is_null_occurrenceS");
   u00189 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00189, "system__tasking__rendezvousB");
   u00190 : constant Version_32 := 16#da433d5e#;
   ...
   u00192 : constant Version_32 := 16#45aa48e1#;
   pragma Export (C, u00192, "system__restrictionsS");
   u00193 : constant Version_32 := 16#886988be#;
   ...
   u00195 : constant Version_32 := 16#d499f4ac#;
   pragma Export (C, u00195, "system__tasking__initializationB");
   u00196 : constant Version_32 := 16#cd0eb8a9#;
   pragma Export (C, u00196, "system__tasking__initializationS");
   u00197 : constant Version_32 := 16#132211d8#;
   pragma Export (C, u00197, "system__tasking__task_attributesB");
   u00198 : constant Version_32 := 16#7dbadc03#;
   pragma Export (C, u00198, "system__tasking__task_attributesS");
   u00199 : constant Version_32 := 16#d5216b8e#;
   pragma Export (C, u00199, "system__tasking__protected_objects__entriesB");
   u00200 : constant Version_32 := 16#7daf93e7#;
   pragma Export (C, u00200, "system__tasking__protected_objects__entriesS");
   u00201 : constant Version_32 := 16#ef7f0714#;
   pragma Export (C, u00201, "system__tasking__protected_objects__operationsB");
   u00202 : constant Version_32 := 16#07408f44#;
   pragma Export (C, u00202, "system__tasking__protected_objects__operationsS");
   u00203 : constant Version_32 := 16#1f882186#;
   pragma Export (C, u00203, "system__tasking__queuingB");
   u00204 : constant Version_32 := 16#73e13001#;
   pragma Export (C, u00204, "system__tasking__queuingS");
   u00205 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00205, "system__tasking__utilitiesB");
   u00206 : constant Version_32 := 16#6b757be7#;
   pragma Export (C, u00206, "system__tasking__utilitiesS");
   u00207 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00207, "system__tasking__stagesB");
   u00208 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00208, "system__tasking__stagesS");
   u00209 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00209, "system__memoryB");
   u00210 : constant Version_32 := 16#76873720#;
